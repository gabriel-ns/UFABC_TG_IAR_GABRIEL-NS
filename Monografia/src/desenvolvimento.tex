...
% TODO define reference to adv interval
...
\begin{center}
	\centering 
	\includegraphics[width=0.4\linewidth]{fig:nodemcu32.jpg}
...
forma gratuita o sistema operacional Amazon FREE-RTOS, uma versão do FREE-RTOS
customizada pela Amazon, que amplia as funcionalidades com bibliotecas de
software que auxiliam a conexão de sistemas embarcados com os serviços de nuvem AWS.
